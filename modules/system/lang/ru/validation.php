...
return [
    ...
    */
    ...
    'auth_profile' => [
        'phone_number_required' => 'Номер телефона обязательное поле.',
        'phone_number_numeric' => 'Номер телефона должен состоять из цифр.',
        'phone_number_digits_between' => 'Номер телефона должен содержать от 8 до 20 цифр.',
        'phone_number_unique' => 'Пользователь с таким номером телефоном уже существует.',

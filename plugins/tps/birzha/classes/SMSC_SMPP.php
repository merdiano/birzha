...
// define("SMSC_HOST", "217.174.228.218");    // адрес SMPP-сервера
define("SMSC_PORT", 5019);                // порт подключения
define("SMSC_LOGIN", "birja");        // логин клиента
define("SMSC_PASSWORD", "Birj@1");    // пароль
